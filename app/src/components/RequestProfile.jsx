...
const RequestProfile = () => {
  ...
  { 
    ...
    role: 'UX Researcher', 
    company: 'TechCorp', 
    avatar: 'https://placehold.co/120x120/violet/white?text=JP', 
    location: 'San Francisco, CA', 
    skills: ['User Research', 'Wireframing', 'Prototyping'], 
    bio: 'UX researcher passionate about understanding user needs and transforming insights into better product experiences.', 
    phone: '+1 (555) 210-9876', 
    socialLinks: { 
      linkedin: 'linkedin.com/in/jenniferparker', 
      dribbble: 'dribbble.com/jennparker' 
    } 
  },
  { 
    id: 2, 
    ...
    avatar: 'https://placehold.co/120x120/violet/white?text=RK', 
    location: 'Austin, TX', 
    skills: ['React', 'JavaScript', 'Next.js'], 
    bio: 'Frontend developer building modern, responsive web applications with clean and maintainable code.', 
  ...
  { 
    ...
    company: 'StartupXYZ', 
    avatar: 'https://placehold.co/120x120/violet/white?text=LC', 
    location: 'Seattle, WA', 
    skills: ['Agile', 'Roadmaps', 'User Stories'], 
    bio: 'Product manager experienced in leading cross-functional teams to deliver user-driven solutions.', 
    phone: '+1 (555) 432-7891', 
    socialLinks: { 
  ...
  { 
    ...
    avatar: 'https://placehold.co/120x120/violet/white?text=MJ', 
    location: 'Boston, MA', 
    skills: ['Python', 'Machine Learning', 'SQL'], 
    bio: 'Data scientist with experience in predictive modeling and turning data into actionable insights.', 
    phone: '+1 (555) 543-8765', 
    socialLinks: { 
      linkedin: 'linkedin.com/in/marcusjohnson', 
      kaggle: 'kaggle.com/marcusjohnson' 
    } 
  },
  { 
    id: 5, 
    ...
    company: 'Growth Inc.', 
    avatar: 'https://placehold.co/120x120/violet/white?text=SW', 
    location: 'New York, NY', 
    skills: ['SEO', 'Content Strategy', 'Digital Campaigns'], 
    bio: 'Marketing director focused on scaling businesses through creative storytelling and data-driven strategies.', 
    phone: '+1 (555) 654-3219', 
    socialLinks: { 
      linkedin: 'linkedin.com/in/sophiawilliams', 
      twitter: 'twitter.com/sophiagrowth' 
    } 
  },
  { 
    id: 6, 
    ...
    company: 'CodeCraft', 
    avatar: 'https://placehold.co/120x120/violet/white?text=DB', 
    location: 'Denver, CO', 
    skills: ['Node.js', 'React', 'MongoDB'], 
    bio: 'Full stack developer with a passion for scalable applications and modern web technologies.', 
    phone: '+1 (555) 765-0981', 
    socialLinks: { 
  ...
  const user = requestsData.find(u => u.id === parseInt(userId));
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 mb-6">
        <button
          onClick={() => navigate('/profile/pending-requests')}
          className="flex items-center gap-2 px-4 py-2 text-gray-300 hover:bg-gray-500 rounded-lg transition-colors"
        >
          <ArrowLeft size={18} />
        Back to Requests
        </button>
